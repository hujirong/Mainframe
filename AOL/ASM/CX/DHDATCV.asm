...
*     Author : Marvin 4QEM DENISE                                   *   00002200
...
*********************************************************************   00009900
DHDATCV CSECT                                                           00010000
DHDATCV amode 31                                                        00010100
DHDATCV rmode any                                                       00010200
         PRINT OFF                                                      00010000
R0       EQU   0                                                        00010100
R1       EQU   1                                                        00010200
R2       EQU   2                                                        00010300
...
R15      EQU   15                                                       00017000
         PRINT ON                                                       00018000
DHDATCV CSECT                                                           00019000
         STM    R14,R12,12(R13)                                         00020000
         USING  DHDATCV,R12                                             00030000
         LR     R12,R15                                                 00040000
         B      *+20                                                    00050000
         DC     CL8'DHDATCV'                                            00060000
